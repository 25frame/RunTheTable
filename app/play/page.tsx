      ...
      <div className="mt-8 grid gap-5 md:grid-cols-2">
        <Card>
          ...
          <div className="mt-5 space-y-3 text-white/70">
            <p>
              <b className="text-white">Location:</b> TBD NYC tables
            </p>
            <p>
              <b className="text-white">Entry:</b> $15
            </p>
            <p>
              <b className="text-white">Prize Model:</b> $12 prize pool / $3 operations
            </p>
            <p>
              <b className="text-white">Format:</b> weekly league / tournament play
            </p>
          </div>
        </Card>
        ...
        <Card className="border-rtt-red/40 bg-rtt-red/10">
          ...
          <p className="mt-3 text-white/65">
            Use the official RTT NYC Google Form. Responses flow into the league ops sheet.
          </p>
          <a
            href={formUrl}
            target="_blank"
