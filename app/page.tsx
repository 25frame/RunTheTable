        ...
        <div className="grid gap-8 lg:grid-cols-[1.25fr_0.75fr]">
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-black/55 p-7 shadow-2xl shadow-red-950/30 md:p-10">
            ...
            <div className="relative">
              <p className="text-xs font-black uppercase tracking-[0.38em] text-rtt-red">RTT NYC</p>
              ...
              <p className="mt-6 max-w-2xl text-lg font-medium leading-8 text-white/65">Weekly competitive table tennis. Live scores, rankings, profiles, and payouts.</p>
              <div className="mt-8 flex flex-wrap gap-3">
                <a href={formUrl} target="_blank" rel="noopener noreferrer" className="rounded-2xl bg-rtt-red px-6 py-4 text-sm font-black uppercase tracking-[0.2em] shadow-lg shadow-red-950/40 transition hover:scale-[1.02]">Join This Week</a>
                <Link href="/live" className="rounded-2xl border border-white/15 bg-white/5 px-6 py-4 text-sm font-black uppercase tracking-[0.2em] text-white/80 transition hover:border-white/30 hover:bg-white/10">Live Scores</Link>
              </div>
            </div>
          </div>
              ...
              <Card className="group overflow-hidden p-0 transition hover:-translate-y-1 hover:border-rtt-red/70">
                <div className="relative h-52 bg-black">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    ...
                    <p className="mt-1 text-sm text-white/65">{p.wins}-{p.losses} · {p.points} pts · {p.streak || "Active"}</p>
                  </div>
                </div>
              </Card>
            </Link>
