          ...
          {latest ? (
            <div className="p-6 md:p-10">
              ...
              <div className="mt-8 grid grid-cols-[1fr_auto_1fr] items-center gap-3">
                <div className="rounded-[2rem] bg-black/60 p-6 text-center"><p className="text-7xl font-black md:text-9xl">{latest.scoreA ?? latest.score?.split("-")[0] ?? 0}</p></div>
                <div className="text-3xl font-black text-white/30">-</div>
                <div className="rounded-[2rem] bg-black/60 p-6 text-center"><p className="text-7xl font-black md:text-9xl">{latest.scoreB ?? latest.score?.split("-")[1] ?? 0}</p></div>
              </div>
